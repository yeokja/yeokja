...
번역은 [yeokja](https://github.com/yeokja/yeokja)의 `claude_code` provider와 `claude-opus-5-5` 모델로 수행합니다. Anthropic 사의 `claude-opus-5-5` 모델을 활용하여 번역되었으며 학습을 모두 비허용한 상태로 작업하였습니다.
